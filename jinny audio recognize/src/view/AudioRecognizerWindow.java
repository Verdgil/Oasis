...
public class AudioRecognizerWindow extends JFrame {
	...
	private static final int FUZ_FACTOR = 2; /*дерьмо, отвечает за четкость записи, так заебись для напева */
	...
	public void createWindow() {
		...
		Button buttonStart = new Button("добавить");
		Button buttonMatch = new Button("сравнить!");
		Button buttonStartMatch = new Button("запись фрагмента");
	//	Button buttonStopMatch = new Button("Stop Match");
		fileTextField = new JTextField(20);
		output = new JTextField(20);
		fileTextField.setText("путь к файлу");
		...
		buttonMatch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				output.setText("Best song id: " + bestSong);
			}
		});
